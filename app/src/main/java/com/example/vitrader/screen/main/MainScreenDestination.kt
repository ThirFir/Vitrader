...
enum class MainScreenDestination(val route: String, val description: String, val screen : @Composable () -> Unit){
    ...
    COIN_LIST("coin_list", "coin list", { CoinListScreen(androidx.lifecycle.viewmodel.compose.viewModel(), androidx.lifecycle.viewmodel.compose.viewModel(), androidx.lifecycle.viewmodel.compose.viewModel()) {} } ),
